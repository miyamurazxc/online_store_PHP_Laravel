                ...
                <div class="col-12">
                    <div class="table-responsive">
                        <table class="table shopping-summery text-center clean">
                                    ...
                                    @foreach (Cart::content() as $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="font-xs">{{ $item->model->brief_description }}</p>
                                            </td>
                                            <td class="price" data-title="Цена"><span>₸{{ $item->model->price }}</span></td>
                                            ...
                                            <td class="text-right" data-title="Сумма">
                                                <span>₸{{ $item->subtotal }}</span>
                                            </td>
                                            <td class="action" data-title="Удалить">
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-end">
                                            <form action="{{ route('destroy.cart') }}" method="post">
                                                ...
                                                @method('DELETE')
                                                <a onclick="event.preventDefault(); this.closest('form').submit()" class="text-muted">
                                                    <i class="fi-rs-cross-small"></i> Очистить корзину
                                                </a>
                                            </form>
                                        </td>
                                    </tr>
                            ...
                            @else
                                <h1 class="text-xl font-bold pb-20">Корзина пуста</h1>
                            @endif
                        </table>
                    </div>
                                ...
                                <div class="rounded-xl cart-totals">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td class="cart_total_label">Сумма товаров</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount">
                                                        <i class="ti-gift mr-5"></i> Бесплатная доставка
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="cart_total_label">Налог</td>
                                                    <td class="cart_total_amount">
                                                        <i class="ti-gift mr-5"></i>
                                                        <strong class="font-xl text-red-500">₸{{ Cart::tax() }}</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="cart_total_label">Итого</td>
                                                    <td class="cart_total_amount">
                                    ...
                                    <div class="cart-action text-end">
                                        <a href="{{ route('checkout') }}" class="btn">
                                            <i class="fi-rs-box-alt mr-10"></i> Перейти к оформлению
                                        </a>
                                    </div>
                                </div>
                            </div>
