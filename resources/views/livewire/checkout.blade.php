    ...
    <section class="mt-50 mb-50">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-25">
                        <h4 class="font-semibold text-lg text-gray-600">Платёжные данные</h4>
                    </div>
                    <form method="post" action="{{ route('checkout.order') }}" id="checkoutForm">
                        ...
                        <div class="mb-4">
                            <x-input-label for="billing_address" :value="'Адрес *'" />
                            <x-text-input id="billing_address" name="billing_address" type="text"
                                class="mt-1 block w-full"
                                value="{{ $billingDetails ? $billingDetails->billing_address : '' }}"
                        ...
                        <div class="mb-4">
                            <x-input-label for="state" :value="'Область / Регион *'" />
                        ...
                        <div class="mb-4">
                            <x-input-label for="zipcode" :value="'Почтовый индекс *'" />
                        ...
                        <div class="form-group mb-30">
                            <x-input-label for="order_notes" :value="'Дополнительная информация'" />
                            <x-text-input id="order_notes" name="order_notes" type="text" class="mt-1 block w-full"
                                autofocus autocomplete="order_notes" placeholder="Есть ли пожелания к заказу?"
                                value="{{ $billingDetails ? $billingDetails->order_notes : '' }}" />
                        </div>
                    </form>
                </div>
                ...
                <div class="col-md-6">
                    <div class="order_review border-0">
                        <div class="mb-5">
                            <h3 class="my-2 text-lg font-semibold text-gray-600">Ваш заказ</h3>
                        </div>
                        ...
                        <div class="table-responsive order_table text-center">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Доставка</th>
                                        <td colspan="2"><em>Бесплатная доставка</em></td>
                                    </tr>
                                    <tr>
                                        <th>Итого</th>
