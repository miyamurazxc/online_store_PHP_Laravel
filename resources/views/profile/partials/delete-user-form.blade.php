<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 pooortext-gray-400">
            {{ __('После удаления аккаунта все связанные данные и ресурсы будут безвозвратно удалены. Пожалуйста, заранее сохраните нужную вам информацию.') }}
        </p>
    </header>
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <p class="mt-1 text-sm text-gray-600 pooortext-gray-400">
                {{ __('После удаления аккаунта все данные будут удалены без возможности восстановления. Пожалуйста, введите пароль для подтверждения.') }}
            </p>
